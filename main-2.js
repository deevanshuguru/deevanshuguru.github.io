/**
 * Made with ❤ by MagmaCray (https://magmacray.com)
 * For any queries please write us at support@magmacray.com
 * Have a great day!
 */
(this.webpackJsonpportfolio = this.webpackJsonpportfolio || []).push([[2], [function (e, t, n) {
    "use strict";
    e.exports = n(12)
}, function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0});
    var r = t.IS_SERVER = "undefined" === typeof window;
    t.BACK_REGEX = /\/?\.?[\w-_]+\/\.\./, t.Errors = {
        ...
        LANG: function () {
            return r ? "en_US.UTF-8" : navigator.language.replace("-", "_") + ".UTF-8"
        },
        HOME: "/",
        LOGNAME: function (e) {
            return e.settings.user.username
    ...
    t.trim = i, t.appendError = function (e, t, n) {
        return Object.assign({}, e, {error: !0, history: e.history.concat({value: t.replace("$1", n)})})
    }, t.extractPath = function (e, t) {
        if ("" === e) return t;
        e = i(e, "/");
        var n = (t ? t + "/" : "") + e;
        for (; n.match(l.BACK_REGEX);) n = n.replace(l.BACK_REGEX, "");
        return i(n, "/")
    }, t.getDirectoryByPath = function (e, t) {
        var n = t.split("/");
        if (!n[0]) return {dir: e};
        var i = e, o = 0;
        for (; o < n.length;) {
            var a = n[o], u = i[a];
            if (!u || "object" !== ("undefined" === typeof u ? "undefined" : r(u))) return {err: l.Errors.NO_SUCH_FILE.replace("$1", t)};
            if (u.hasOwnProperty("content")) return {err: l.Errors.NOT_A_DIRECTORY.replace("$1", t)};
            i = u, o++
        }
        return {dir: i}
    }, t.getEnvVariables = function (e) {
        return Object.keys(l.EnvVariables).reduce((function (t, n) {
            var r = l.EnvVariables[n];
            return t[n] = "function" === typeof r ? r(e) : r, t
        }), {})
    }, t.isFile = function (e) {
    ...
    function i(e, t) {
        return e[0] === t && (e = e.substr(1)), e[e.length - 1] === t && (e = e.substr(0, e.length - 1)), e
    }
}, function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.BashUtil = t.BashConst = void 0;
    var r, l = n(17), i = (r = l) && r.__esModule ? r : {default: r}, o = u(n(6)), a = u(n(1));
    ...
    t.default = i.default, t.BashConst = a, t.BashUtil = o
}, function (e, t, n) {
    "use strict";
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.rm = t.whoami = t.printenv = t.echo = t.pwd = t.cd = t.mkdir = t.cat = t.ls = t.clear = t.help = void 0;
    var r = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
    ...
    var o = ["clear", "ls", "cat", "mkdir", "cd", "pwd", "echo", "printenv", "whoami", "rm", "PS: These commands are not working :-("];
    t.help = {
        exec: function (e) {
            var t;
            return Object.assign({}, e, {
                history: (t = e.history).concat.apply(t, [{value: "MagmaCray-System:"}, {value: "These shell commands are defined internally.  Type 'help' to see this list."}].concat(i(o.map((function (e) {
                    return {value: e}
                })))))
            })
        }
        ...
        exec: function (e) {
            return Object.assign({}, e, {history: []})
        }
    }, t.ls = {
        exec: function (e, t) {
            var n = t.flags, l = t.args[0] || "", i = r.extractPath(l, e.cwd), o = r.getDirectoryByPath(e.structure, i),
                a = o.err, u = o.dir;
            if (a) return r.appendError(e, a, l);
            var c = Object.keys(u);
            return n.a || (c = c.filter((function (e) {
                return "." !== e[0]
            }))), n.l ? Object.assign({}, e, {
                history: e.history.concat(c.map((function (e) {
                    return {value: e}
                })))
            }) : Object.assign({}, e, {history: e.history.concat({value: c.join(" ")})})
        }
    }, t.cat = {
        exec: function (e, t) {
            var n = t.args[0], i = n.split("/"), o = i.pop(), a = r.extractPath(i.join("/"), e.cwd),
                u = r.getDirectoryByPath(e.structure, a), c = u.err, s = u.dir;
            return c ? r.appendError(e, c, n) : s[o] ? s[o].hasOwnProperty("content") ? Object.assign({}, e, {history: e.history.concat({value: s[o].content})}) : r.appendError(e, l.Errors.IS_A_DIRECTORY, n) : r.appendError(e, l.Errors.NO_SUCH_FILE, n)
        }
    }, t.mkdir = {
        exec: function (e, t) {
            var n = t.args[0], i = n.split("/"), o = i.pop(), a = r.extractPath(i.join("/"), e.cwd),
                u = JSON.parse(JSON.stringify(e.structure)), c = r.getDirectoryByPath(u, a).dir;
            return c[o] ? r.appendError(e, l.Errors.FILE_EXISTS, n) : (c[o] = {}, Object.assign({}, e, {structure: u}))
        }
    }, t.cd = {
        exec: function (e, t) {
            var n = t.args[0];
            if (!n || "/" === n) return Object.assign({}, e, {cwd: ""});
            var l = r.extractPath(n, e.cwd), i = r.getDirectoryByPath(e.structure, l).err;
            return i ? r.appendError(e, i, n) : Object.assign({}, e, {cwd: l})
        }
    }, t.pwd = {
        exec: function (e) {
            var t = "/" + e.cwd;
            return Object.assign({}, e, {history: e.history.concat({value: t})})
        }
    }, t.echo = {
        exec: function (e, t) {
            var n = t.input, l = "echo ".length, i = r.getEnvVariables(e),
                o = n.slice(l).replace(/(\$\w+)/g, (function (e) {
                    return i[e.slice(1)] || ""
                }));
            return Object.assign({}, e, {history: e.history.concat({value: o})})
        }
    }, t.printenv = {
        exec: function (e) {
            var t = r.getEnvVariables(e), n = Object.keys(t).map((function (e) {
                return {value: e + "=" + t[e]}
            }));
            return Object.assign({}, e, {history: e.history.concat(n)})
        }
    }, t.whoami = {
        exec: function (e) {
            var t = e.settings.user.username;
            return Object.assign({}, e, {history: e.history.concat({value: t})})
        }
    }, t.rm = {
        exec: function (e, t) {
            var n = t.flags, i = t.args[0], o = i.split("/"), a = o.pop(), u = r.extractPath(o.join("/"), e.cwd),
                c = JSON.parse(JSON.stringify(e.structure)), s = r.getDirectoryByPath(c, u).dir;
            return s[a] ? r.isFile(s[a]) || n.r || n.R ? (delete s[a], Object.assign({}, e, {structure: c})) : r.appendError(e, l.Errors.IS_A_DIRECTORY, i) : r.appendError(e, l.Errors.NO_SUCH_FILE, i)
        }
    }
}, function (e, t, n) {
    "use strict";
    ...
    "use strict";
    var r = n(8), l = "function" === typeof Symbol && Symbol.for, i = l ? Symbol.for("react.element") : 60103,
        o = l ? Symbol.for("react.portal") : 60106, a = l ? Symbol.for("react.fragment") : 60107,
        ...
        h = l ? Symbol.for("react.memo") : 60115, m = l ? Symbol.for("react.lazy") : 60116,
    ...
    function I(e, t, n) {
        return null == e ? 0 : function e(t, n, r, l) {
            ...
            if (u = 0, n = "" === n ? "." : n + ":", Array.isArray(t)) for (var c = 0; c < t.length; c++) {
                var s = n + M(a = t[c], c);
                u += e(a, s, r, l)
            } else if (null === t || "object" !== typeof t ? s = null : s = "function" === typeof (s = y && t[y] || t["@@iterator"]) ? s : null, "function" === typeof s) for (t = s.call(t), c = 0; !(a = t.next()).done;) u += e(a = a.value, s = n + M(a, c++), r, l); else if ("object" === a) throw r = "" + t, Error(v(31, "[object Object]" === r ? "object with keys {" + Object.keys(t).join(", ") + "}" : r, ""));
            return u
        }(e, "", t, n)
    }
    ...
    function j(e, t, n, r, l) {
        var i = "";
        null != n && (i = ("" + n).replace(O, "$&/") + "/"), I(e, F, t = R(t, i, r, l)), z(t)
    }
    ...
    function v(e, t, n) {
        ...
        e.currentTarget = y(n), function (e, t, n, r, l, i, a, d, h) {
    ...
    var V = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,
        W = Object.prototype.hasOwnProperty, $ = {}, H = {};
    ...
    var J = /^(.*)[\\\/]/, Z = "function" === typeof Symbol && Symbol.for, ee = Z ? Symbol.for("react.element") : 60103,
        ...
        ie = Z ? Symbol.for("react.provider") : 60109, oe = Z ? Symbol.for("react.context") : 60110,
        ...
        do {
            e:switch (e.tag) {
                ...
                case 9:
                    ...
                    break e;
                default:
                    var r = e._debugOwner, l = e._debugSource, i = ye(e.type);
    ...
    _ && ($e = document.createElement("div").style, "AnimationEvent" in window || (delete Ve.animationend.animation, delete Ve.animationiteration.animation, delete Ve.animationstart.animation), "TransitionEvent" in window || delete Ve.transitionend.transition);
    var Qe = He("animationend"), Ke = He("animationiteration"), qe = He("animationstart"), Ye = He("transitionend"),
    ...
    function Mt() {
        ...
        null !== wt && zt(wt) && (wt = null), null !== kt && zt(kt) && (kt = null), null !== xt && zt(xt) && (xt = null), Et.forEach(It), Tt.forEach(It)
    }
    ...
    var $t = i.unstable_UserBlockingPriority, Ht = i.unstable_runWithPriority, Qt = !0;
    ...
    function Gt(e, t, n, r) {
        if (Qt) if (0 < bt.length && -1 < Ct.indexOf(e)) e = Pt(null, e, t, n, r), bt.push(e); else {
            var l = Jt(e, t, n, r);
            if (null === l) Ot(e, r); else if (-1 < Ct.indexOf(e)) e = Pt(l, e, t, n, r), bt.push(e); else if (!function (e, t, n, r, l) {
                switch (t) {
                    case"focus":
                    ...
                    case"pointerover":
                        var i = l.pointerId;
                        return Et.set(i, Nt(Et.get(i) || null, e, t, n, r, l)), !0;
                    case"gotpointercapture":
                        return i = l.pointerId, Tt.set(i, Nt(Tt.get(i) || null, e, t, n, r, l)), !0
                }
                return !1
            }(l, e, t, n, r)) {
    ...
    function Bn() {
        if (Un) return Un;
        var e, t, n = An, r = n.length, l = "value" in Ln ? Ln.value : Ln.textContent, i = l.length;
    ...
    var ar = {
        eventTypes: nr, extractEvents: function (e, t, n, r) {
            ...
            return i ? (er && "ko" !== n.locale && (or || i !== nr.compositionStart ? i === nr.compositionEnd && or && (l = Bn()) : (An = "value" in (Ln = r) ? Ln.value : Ln.textContent, or = !0)), i = qn.getPooled(i, t, n, r), l ? i.data = l : null !== (l = ir(n)) && (i.data = l), jn(i), l = i) : l = null, (e = Zn ? function (e, t) {
                switch (e) {
                    case"compositionend":
                        return ir(t);
                    case"keypress":
                ...
                if (or) return "compositionend" === e || !Gn && lr(e, t) ? (e = Bn(), Un = An = Ln = null, or = !1, e) : null;
                switch (e) {
                    case"paste":
                        return null;
                    case"keypress":
            ...
            }(e, n)) ? ((t = Yn.getPooled(nr.beforeInput, t, n, r)).data = e, jn(t)) : t = null, null === l ? t : null === t ? l : [l, t]
        }
    }, ur = {
        color: !0,
        date: !0,
    ...
    function fr(e, t, n) {
        return (e = $n.getPooled(sr.change, e, t, n)).type = "change", z(n), jn(e), e
    }
    ...
    var Tr = {
            eventTypes: sr, _isInputEventSupported: vr, extractEvents: function (e, t, n, r) {
                var l = t ? On(t) : window, i = l.nodeName && l.nodeName.toLowerCase();
                if ("select" === i || "input" === i && "file" === l.type) var o = yr; else if (cr(l)) if (vr) o = Er; else {
                    o = kr;
                    var a = wr
    ...
    var Or = 0, Nr = 0, Rr = !1, zr = !1, Ir = Sr.extend({
        screenX: null,
        screenY: null,
        clientX: null,
        clientY: null,
        ...
        eventTypes: Dr, extractEvents: function (e, t, n, r, l) {
            ...
            if ("mouseout" === e || "mouseover" === e) var a = Ir, u = Dr.mouseLeave, c = Dr.mouseEnter,
                s = "mouse"; else "pointerout" !== e && "pointerover" !== e || (a = Mr, u = Dr.pointerLeave, c = Dr.pointerEnter, s = "pointer");
            ...
            for (c = a, a = []; r && r !== c && (null === (o = r.alternate) || o !== c);) a.push(r), r = Rn(r);
    ...
    }, Vr = null, Wr = null, $r = null, Hr = !1;

    function Qr(e, t) {
        var n = t.window === t ? t.document : 9 === t.nodeType ? t : t.ownerDocument;
        return Hr || null == Vr || Vr !== sn(n) ? null : ("selectionStart" in (n = Vr) && hn(n) ? n = {
        ...
        }, $r && Ar($r, n) ? null : ($r = n, (e = $n.getPooled(Br.select, Wr, e, t)).type = "select", e.target = Vr, jn(e), e))
    }

    var Kr = {
        eventTypes: Br, extractEvents: function (e, t, n, r, l, i) {
            ...
            switch (l = t ? On(t) : window, e) {
                case"focus":
                    (cr(l) || "true" === l.contentEditable) && (Vr = l, Wr = t, $r = null);
                    break;
                case"blur":
                    $r = Wr = Vr = null;
                    break;
    ...
    var kl = i.unstable_runWithPriority, xl = i.unstable_scheduleCallback, El = i.unstable_cancelCallback,
        Tl = i.unstable_requestPaint, Sl = i.unstable_now, Cl = i.unstable_getCurrentPriorityLevel,
        _l = i.unstable_ImmediatePriority, Pl = i.unstable_UserBlockingPriority, Ol = i.unstable_NormalPriority,
        Nl = i.unstable_LowPriority, Rl = i.unstable_IdlePriority, zl = {}, Il = i.unstable_shouldYield,
        Ml = void 0 !== Tl ? Tl : function () {
        }, Dl = null, Fl = null, jl = !1, Ll = Sl(), Al = 1e4 > Ll ? Sl : function () {
            return Sl() - Ll
        };
    ...
    function $l(e) {
        return null === Dl ? (Dl = [e], Fl = xl(_l, Ql)) : Dl.push(e), zl
    }
    ...
    function Ql() {
        if (!jl && null !== Dl) {
            ...
            try {
                ...
                throw null !== Dl && (Dl = Dl.slice(e + 1)), xl(_l, Hl), n
            } finally {
                jl = !1
            }
        }
    ...
    function ni(e, t) {
        Xl = e, Jl = Gl = null, null !== (e = e.dependencies) && null !== e.firstContext && (e.expirationTime >= t && (No = !0), e.firstContext = null)
    }
        ...
        if (null !== o) {
            ...
            if (null !== u) for (var h = u; ;) {
                ...
                if (null === (h = h.next) || h === u) {
                    ...
                    h = o.next = a.next, a.next = u, i.baseQueue = o = a, i.shared.pending = null
                }
            }
    ...
    function vi(e, t, n) {
        ...
        return "object" === typeof i && null !== i ? i = ri(i) : (l = ml(t) ? pl : fl.current, i = (r = null !== (r = t.contextTypes) && void 0 !== r) ? hl(e, l) : sl), t = new t(n, i), e.memoizedState = null !== t.state && void 0 !== t.state ? t.state : null, t.updater = mi, e.stateNode = t, t._reactInternalFiber = e, r && ((e = e.stateNode).__reactInternalMemoizedUnmaskedChildContext = l, e.__reactInternalMemoizedMaskedChildContext = i), t
    }
    ...
    function bi(e, t, n, r) {
        ...
        var i = t.contextType;
        "object" === typeof i && null !== i ? l.context = ri(i) : (i = ml(t) ? pl : fl.current, l.context = hl(e, i)), si(e, n, l, r), l.state = e.memoizedState, "function" === typeof (i = t.getDerivedStateFromProps) && (hi(e, t, i, n), l.state = e.memoizedState), "function" === typeof t.getDerivedStateFromProps || "function" === typeof l.getSnapshotBeforeUpdate || "function" !== typeof l.UNSAFE_componentWillMount && "function" !== typeof l.componentWillMount || (t = l.state, "function" === typeof l.componentWillMount && l.componentWillMount(), "function" === typeof l.UNSAFE_componentWillMount && l.UNSAFE_componentWillMount(), t !== l.state && mi.enqueueReplaceState(l, l.state, null), si(e, n, l, r), l.state = e.memoizedState), "function" === typeof l.componentDidMount && (e.effectTag |= 4)
    }
    ...
    function Ei(e) {
        ...
        function d(e, t, n) {
            ...
            if ("object" === typeof t && null !== t) {
                ...
                if (wi(t) || me(t)) return (t = Pu(t, e.mode, n, null)).return = e, t;
                xi(e, t)
            }
            return null
        }
        ...
        function m(l, o, a, u) {
            for (var c = null, s = null, f = o, m = o = 0, y = null; null !== f && m < a.length; m++) {
                ...
                e && f && null === v.alternate && t(l, f), o = i(v, o, m), null === s ? c = v : s.sibling = v, s = v, f = y
            }
            ...
            for (f = r(l, f); m < a.length; m++) null !== (y = h(f, l, m, a[m], u)) && (e && null !== y.alternate && f.delete(null === y.key ? m : y.key), o = i(y, o, m), null === s ? c = y : s.sibling = y, s = y);
        ...
        function y(l, a, u, c) {
            ...
            for (var f = s = null, m = a, y = a = 0, v = null, g = u.next(); null !== m && !g.done; y++, g = u.next()) {
                ...
                e && m && null === b.alternate && t(l, m), a = i(b, a, y), null === f ? s = b : f.sibling = b, f = b, m = v
            }
            ...
            for (m = r(l, m); !g.done; y++, g = u.next()) null !== (g = h(m, l, y, g.value, c)) && (e && null !== g.alternate && m.delete(null === g.key ? y : g.key), a = i(g, a, y), null === f ? s = g : f.sibling = g, f = g);
        ...
        return function (e, r, i, u) {
            ...
            if ("string" === typeof i || "number" === typeof i) return i = "" + i, null !== r && 6 === r.tag ? (n(e, r.sibling), (r = l(r, i)).return = e, e = r) : (n(e, r), (r = Ou(i, e.mode, u)).return = e, e = r), a(e);
    ...
    var Ti = Ei(!0), Si = Ei(!1), Ci = {}, _i = {current: Ci}, Pi = {current: Ci}, Oi = {current: Ci};
    ...
    function Ri(e, t) {
        switch (cl(Oi, t), cl(Pi, e), cl(_i, Ci), e = t.nodeType) {
            case 9:
            case 11:
    ...
    function Ii(e) {
        Ni(Oi.current);
        var t = Ni(_i.current), n = je(t, e.type);
        t !== n && (cl(Pi, e), cl(_i, n))
    }
    ...
    var Li = X.ReactCurrentDispatcher, Ai = X.ReactCurrentBatchConfig, Ui = 0, Bi = null, Vi = null, Wi = null, $i = !1;
    ...
    function Ki(e, t, n, r, l, i) {
        if (Ui = i, Bi = t, t.memoizedState = null, t.updateQueue = null, t.expirationTime = 0, Li.current = null === e || null === e.memoizedState ? vo : go, e = n(r, l), t.expirationTime === Ui) {
            i = 0;
            do {
                if (t.expirationTime = 0, !(25 > i)) throw Error(o(301));
                i += 1, Wi = Vi = null, t.updateQueue = null, Li.current = bo, e = n(r, l)
            } while (t.expirationTime === Ui)
        }
        if (Li.current = yo, t = null !== Vi && null !== Vi.next, Ui = 0, Wi = Vi = Bi = null, $i = !1, t) throw Error(o(300));
        return e
    }
    ...
    function Gi(e) {
        ...
        var r = Vi, l = r.baseQueue, i = n.pending;
        if (null !== i) {
            if (null !== l) {
                var a = l.next;
        ...
        if (null !== l) {
            ...
            do {
                ...
                if (s < Ui) {
                    ...
                    null === u ? (a = u = f, i = r) : u = u.next = f, s > Bi.expirationTime && (Bi.expirationTime = s, ou(s))
            ...
            null === u ? i = r : u.next = a, jr(r, t.memoizedState) || (No = !0), t.memoizedState = r, t.baseState = i, t.baseQueue = u, n.lastRenderedState = r
        }
    ...
    function Ji(e) {
        ...
        if (null !== l) {
            ...
            jr(i, t.memoizedState) || (No = !0), t.memoizedState = i, null === t.baseQueue && (t.baseState = i), n.lastRenderedState = i
        }
        return [i, r]
    }
    ...
    function Zi(e) {
        ...
        return "function" === typeof e && (e = e()), t.memoizedState = t.baseState = e, e = (e = t.queue = {
            ...
            lastRenderedState: e
        }).dispatch = mo.bind(null, Bi, e), [t.memoizedState, e]
    }
    ...
    function no(e, t, n, r) {
        var l = qi();
        Bi.effectTag |= e, l.memoizedState = eo(1 | t, n, void 0, void 0 === r ? null : r)
    }
    ...
    function ro(e, t, n, r) {
        ...
        Bi.effectTag |= e, l.memoizedState = eo(1 | t, n, i, r)
    }
    ...
    function mo(e, t, n) {
        ...
        var i = t.pending;
        if (null === i ? l.next = l : (l.next = i.next, i.next = l), t.pending = l, i = e.alternate, e === Bi || null !== i && i === Bi) $i = !0, l.expirationTime = Ui, Bi.expirationTime = Ui; else {
    ...
    var yo = {
        ...
        readContext: ri, useCallback: so, useContext: ri, useEffect: lo, useImperativeHandle: function (e, t, n) {
            ...
            return t = void 0 !== n ? n(t) : t, r.memoizedState = r.baseState = t, e = (e = r.queue = {
                ...
                lastRenderedState: t
            }).dispatch = mo.bind(null, Bi, e), [r.memoizedState, e]
        }, useRef: function (e) {
            return e = {current: e}, qi().memoizedState = e
        }, useState: Zi, useDebugValue: co, useResponder: ji, useDeferredValue: function (e, t) {
    ...
    var Oo = X.ReactCurrentOwner, No = !1;
    ...
    function zo(e, t, n, r, l) {
        n = n.render;
        var i = t.ref;
        return ni(t, l), r = Ki(e, t, n, r, i, l), null === e || No ? (t.effectTag |= 1, Ro(e, t, r, l), t.child) : (t.updateQueue = e.updateQueue, t.effectTag &= -517, e.expirationTime <= l && (e.expirationTime = 0), qo(e, t, l))
    }

    function Io(e, t, n, r, l, i) {
        if (null === e) {
            var o = n.type;
            return "function" !== typeof o || Su(o) || void 0 !== o.defaultProps || null !== n.compare || void 0 !== n.defaultProps ? ((e = _u(n.type, null, r, null, t.mode, i)).ref = t.ref, e.return = t, t.child = e) : (t.tag = 15, t.type = o, Mo(e, t, o, r, l, i))
        }
    ...
    function Mo(e, t, n, r, l, i) {
        return null !== e && Ar(e.memoizedProps, r) && e.ref === t.ref && (No = !1, l < i) ? (t.expirationTime = e.expirationTime, qo(e, t, i)) : Fo(e, t, n, r, i)
    }
    ...
    function Fo(e, t, n, r, l) {
        ...
        return i = hl(t, i), ni(t, l), n = Ki(e, t, n, r, i, l), null === e || No ? (t.effectTag |= 1, Ro(e, t, n, l), t.child) : (t.updateQueue = e.updateQueue, t.effectTag &= -517, e.expirationTime <= l && (e.expirationTime = 0), qo(e, t, l))
    }
    ...
    function jo(e, t, n, r, l) {
        ...
        if (ni(t, l), null === t.stateNode) null !== e && (e.alternate = null, t.alternate = null, t.effectTag |= 2), vi(t, n, r), bi(t, n, r, l), r = !0; else if (null === e) {
            ...
            "object" === typeof c && null !== c ? c = ri(c) : c = hl(t, c = ml(n) ? pl : fl.current);
            ...
            o.state = d, si(t, r, o, l), u = t.memoizedState, a !== r || d !== u || dl.current || li ? ("function" === typeof s && (hi(t, n, s, r), u = t.memoizedState), (a = li || yi(t, n, a, r, d, u, c)) ? (f || "function" !== typeof o.UNSAFE_componentWillMount && "function" !== typeof o.componentWillMount || ("function" === typeof o.componentWillMount && o.componentWillMount(), "function" === typeof o.UNSAFE_componentWillMount && o.UNSAFE_componentWillMount()), "function" === typeof o.componentDidMount && (t.effectTag |= 4)) : ("function" === typeof o.componentDidMount && (t.effectTag |= 4), t.memoizedProps = r, t.memoizedState = u), o.props = r, o.state = u, o.context = c, r = a) : ("function" === typeof o.componentDidMount && (t.effectTag |= 4), r = !1)
    ...
    function Lo(e, t, n, r, l, i) {
        ...
        return t.effectTag |= 1, null !== e && o ? (t.child = Ti(t, e.child, null, i), t.child = Ti(t, null, a, i)) : Ro(e, t, a, i), t.memoizedState = r.state, l && wl(t, n, !0), t.child
    }

    function Ao(e) {
        var t = e.stateNode;
        t.pendingContext ? vl(0, t.pendingContext, t.pendingContext !== t.context) : t.context && vl(0, t.context, !1), Ri(e, t.containerInfo)
    }

    var Uo, Bo, Vo, Wo = {dehydrated: null, retryTime: 0};

    function $o(e, t, n) {
        var r, l = t.mode, i = t.pendingProps, o = Di.current, a = !1;
        if ((r = 0 !== (64 & t.effectTag)) || (r = 0 !== (2 & o) && (null === e || null !== e.memoizedState)), r ? (a = !0, t.effectTag &= -65) : null !== e && null === e.memoizedState || void 0 === i.fallback || !0 === i.unstable_avoidThisFallback || (o |= 1), cl(Di, 1 & o), null === e) {
            if (void 0 !== i.fallback && So(t), a) {
                ...
                return (n = Pu(a, l, n, null)).return = t, i.sibling = n, t.memoizedState = Wo, t.child = i, n
            }
        ...
        if (null !== e.memoizedState) {
            if (l = (e = e.child).sibling, a) {
                ...
                return (l = Cu(l, i)).return = t, n.sibling = l, n.childExpirationTime = 0, t.memoizedState = Wo, t.child = n, l
            }
        ...
        if (e = e.child, a) {
            ...
            return (n = Pu(a, l, n, null)).return = t, i.sibling = n, n.effectTag |= 2, i.childExpirationTime = 0, t.memoizedState = Wo, t.child = i, n
        }
    ...
    function Ko(e, t, n) {
        ...
        if (cl(Di, r), 0 === (2 & t.mode)) t.memoizedState = null; else switch (l) {
            case"forwards":
                for (n = t.child, l = null; null !== n;) null !== (e = n.alternate) && null === Fi(e) && (l = n), n = n.sibling;
                null === (n = l) ? (l = t.child, t.child = null) : (l = n.sibling, n.sibling = null), Qo(t, !1, l, n, i, t.lastEffect);
                break;
            case"backwards":
    ...
    function Xo(e, t, n) {
        ...
        switch (t.tag) {
            ...
            case 3:
                return zi(), ul(dl), ul(fl), (n = t.stateNode).pendingContext && (n.context = n.pendingContext, n.pendingContext = null), null !== e && null !== e.child || !_o(t) || (t.effectTag |= 4), null;
            case 5:
                Mi(t), n = Ni(Oi.current);
                var i = t.type;
                if (null !== e && null != t.stateNode) Bo(e, t, i, r, n), e.ref !== t.ref && (t.effectTag |= 128); else {
                    if (!r) {
                        if (null === t.stateNode) throw Error(o(166));
                        return null
                    }
                    if (e = Ni(_i.current), _o(t)) {
                        ...
                        switch (r[Tn] = t, r[Sn] = a, i) {
                            ...
                            case"input":
                                ...
                                break;
                            case"select":
                                r._wrapperState = {wasMultiple: !!a.multiple}, Kt("invalid", r), un(n, "onChange");
                                break;
                            case"textarea":
                        ...
                        switch (u = 9 === n.nodeType ? n : n.ownerDocument, e === an && (e = Fe(i)), e === an ? "script" === i ? ((e = u.createElement("div")).innerHTML = "<script><\/script>", e = e.removeChild(e.firstChild)) : "string" === typeof r.is ? e = u.createElement(i, {is: r.is}) : (e = u.createElement(i), "select" === i && (u = e, r.multiple ? u.multiple = !0 : r.size && (u.size = r.size))) : e = u.createElementNS(e, i), e[Tn] = t, e[Sn] = r, Uo(e, t), t.stateNode = e, u = on(i, r), i) {
                            case"iframe":
                            case"object":
                            case"embed":
                                Kt("load", e), c = r;
                ...
                return null;
            case 6:
                if (e && null != t.stateNode) Vo(0, t, e.memoizedProps, r); else {
                    if ("string" !== typeof r && null === t.stateNode) throw Error(o(166));
                    n = Ni(Oi.current), Ni(_i.current), _o(t) ? (n = t.stateNode, r = t.memoizedProps, n[Tn] = t, n.nodeValue !== r && (t.effectTag |= 4)) : ((n = (9 === n.nodeType ? n : n.ownerDocument).createTextNode(r))[Tn] = t, t.stateNode = n)
                }
                return null;
            case 13:
                return ul(Di), r = t.memoizedState, 0 !== (64 & t.effectTag) ? (t.expirationTime = n, t) : (n = null !== r, r = !1, null === e ? void 0 !== t.memoizedProps.fallback && _o(t) : (r = null !== (i = e.memoizedState), n || null === i || null !== (i = e.child.sibling) && (null !== (a = t.firstEffect) ? (t.firstEffect = i, i.nextEffect = a) : (t.firstEffect = t.lastEffect = i, i.nextEffect = null), i.effectTag = 8)), n && !r && 0 !== (2 & t.mode) && (null === e && !0 !== t.memoizedProps.unstable_avoidThisFallback || 0 !== (1 & Di.current) ? _a === wa && (_a = ka) : (_a !== wa && _a !== ka || (_a = xa), 0 !== za && null !== Ta && (Iu(Ta, Ca), Mu(Ta, za)))), (n || r) && (t.effectTag |= 4), null);
            case 4:
                return zi(), null;
            case 10:
                return ei(t), null;
            ...
            case 19:
                ...
                return null !== r.tail ? (0 === r.tailExpiration && (r.tailExpiration = Al() + 500), n = r.tail, r.rendering = n, r.tail = n.sibling, r.lastEffect = t.lastEffect, r.renderingStartTime = Al(), n.sibling = null, t = Di.current, cl(Di, i ? 1 & t | 2 : 1 & t), n) : null
        }
    ...
    function Go(e) {
        switch (e.tag) {
            ...
            case 3:
                if (zi(), ul(dl), ul(fl), 0 !== (64 & (t = e.effectTag))) throw Error(o(285));
                return e.effectTag = -4097 & t | 64, e;
            case 5:
                return Mi(e), null;
            case 13:
                return ul(Di), 4096 & (t = e.effectTag) ? (e.effectTag = -4097 & t | 64, e) : null;
            case 19:
                return ul(Di), null;
            case 4:
                return zi(), null;
    ...
    Uo = function (e, t) {
        ...
        if (o !== r) {
            ...
            for (a in r) {
                ...
                } else n || (e || (e = []), e.push(a, n)), n = s; else "dangerouslySetInnerHTML" === a ? (s = s ? s.__html : void 0, c = c ? c.__html : void 0, null != s && c !== s && (e = e || []).push(a, s)) : "children" === a ? c === s || "string" !== typeof s && "number" !== typeof s || (e = e || []).push(a, "" + s) : "suppressContentEditableWarning" !== a && "suppressHydrationWarning" !== a && (T.hasOwnProperty(a) ? (null != s && un(i, a), e || c === s || (e = [])) : (e = e || []).push(a, s))
            }
    ...
    function fa(e, t) {
        switch (t.tag) {
            ...
            case 12:
                return;
            case 13:
                if (n = t, null === t.memoizedState ? r = !1 : (r = !0, n = t.child, Ma = Al()), null !== n) e:for (e = n; ;) {
    ...
    var ya, va = Math.ceil, ga = X.ReactCurrentDispatcher, ba = X.ReactCurrentOwner, wa = 0, ka = 3, xa = 4, Ea = 0,
        Ta = null, Sa = null, Ca = 0, _a = wa, Pa = null, Oa = 1073741823, Na = 1073741823, Ra = null, za = 0, Ia = !1,
        Ma = 0, Da = null, Fa = !1, ja = null, La = null, Aa = !1, Ua = null, Ba = 90, Va = null, Wa = 0, $a = null,
        Ha = 0;
    ...
    function qa(e, t) {
        if (50 < Wa) throw Wa = 0, $a = null, Error(o(185));
        if (null !== (e = Ya(e, t))) {
            var n = Ul();
            1073741823 === t ? 0 !== (8 & Ea) && 0 === (48 & Ea) ? Za(e) : (Ga(e), 0 === Ea && Hl()) : Ga(e), 0 === (4 & Ea) || 98 !== n && 99 !== n || (null === Va ? Va = new Map([[e, t]]) : (void 0 === (n = Va.get(e)) || n > t) && Va.set(e, t))
        }
    }
    ...
    function Ga(e) {
        if (0 !== e.lastExpiredTime) e.callbackExpirationTime = 1073741823, e.callbackPriority = 99, e.callbackNode = $l(Za.bind(null, e)); else {
            ...
            if (0 === t) null !== n && (e.callbackNode = null, e.callbackExpirationTime = 0, e.callbackPriority = 90); else {
                ...
                e.callbackExpirationTime = t, e.callbackPriority = r, t = 1073741823 === t ? $l(Za.bind(null, e)) : Wl(r, Ja.bind(null, e), {timeout: 10 * (1073741821 - t) - Al()}), e.callbackNode = t
            }
        }
    }

    function Ja(e, t) {
        if (Ha = 0, t) return Du(e, t = Qa()), Ga(e), null;
        var n = Xa(e);
        if (0 !== n) {
            ...
            if (mu(), e === Ta && n === Ca || nu(e, n), null !== Sa) {
                ...
                if (Zl(), Ea = r, ga.current = l, 1 === _a) throw t = Pa, nu(e, n), Iu(e, n), Ga(e), t;
                if (null === Sa) switch (l = e.finishedWork = e.current.alternate, e.finishedExpirationTime = n, r = _a, Ta = null, r) {
                    ...
                    case 2:
                        ...
                        break;
                    case ka:
                        if (Iu(e, n), n === (r = e.lastSuspendedTime) && (e.nextKnownPendingLevel = fu(l)), 1073741823 === Oa && 10 < (l = Ma + 500 - Al())) {
                            if (Ia) {
                        ...
                        break;
                    case xa:
                        if (Iu(e, n), n === (r = e.lastSuspendedTime) && (e.nextKnownPendingLevel = fu(l)), Ia && (0 === (l = e.lastPingedTime) || l >= n)) {
                            e.lastPingedTime = n, nu(e, n);
                            break
                        }
                        ...
                        if (1073741823 !== Na ? r = 10 * (1073741821 - Na) - Al() : 1073741823 === Oa ? r = 0 : (r = 10 * (1073741821 - Oa) - 5e3, 0 > (r = (l = Al()) - r) && (r = 0), (n = 10 * (1073741821 - n) - l) < (r = (120 > r ? 120 : 480 > r ? 480 : 1080 > r ? 1080 : 1920 > r ? 1920 : 3e3 > r ? 3e3 : 4320 > r ? 4320 : 1960 * va(r / 1960)) - r) && (r = n)), 10 < r) {
    ...
    function Za(e) {
        ...
        if (mu(), e === Ta && t === Ca || nu(e, t), null !== Sa) {
            ...
            if (Zl(), Ea = n, ga.current = r, 1 === _a) throw n = Pa, nu(e, t), Iu(e, t), Ga(e), n;
    ...
    function nu(e, t) {
        ...
        Ta = e, Sa = Cu(e.current, null), Ca = t, _a = wa, Pa = null, Na = Oa = 1073741823, Ra = null, za = 0, Ia = !1
    }

    function ru(e, t) {
        for (; ;) {
            try {
                if (Zl(), Li.current = yo, $i) for (var n = Bi.memoizedState; null !== n;) {
                    var r = n.queue;
                    null !== r && (r.pending = null), n = n.next
                }
                if (Ui = 0, Wi = Vi = Bi = null, $i = !1, null === Sa || null === Sa.return) return _a = 1, Pa = t, Sa = null;
                e:{
                    var l = e, i = Sa.return, o = Sa, a = t;
    ...
    function iu(e, t) {
        e < Oa && 2 < e && (Oa = e), null !== t && e < Na && 2 < e && (Na = e, Ra = t)
    }
    ...
    function pu(e, t) {
        ...
        if (e.firstPendingTime = l, r <= e.lastSuspendedTime ? e.firstSuspendedTime = e.lastSuspendedTime = e.nextKnownPendingLevel = 0 : r <= e.firstSuspendedTime && (e.firstSuspendedTime = r - 1), r <= e.lastPingedTime && (e.lastPingedTime = 0), r <= e.lastExpiredTime && (e.lastExpiredTime = 0), e === Ta && (Sa = Ta = null, Ca = 0), 1 < n.effectTag ? null !== n.lastEffect ? (n.lastEffect.nextEffect = n, l = n.firstEffect) : l = n : l = n.firstEffect, null !== l) {
            ...
            yn = {activeElementDetached: null, focusedElem: a, selectionRange: u}, Qt = !1, Da = l;
            do {
                try {
                    hu()
                } catch (C) {
            ...
            Qt = !!mn, yn = mn = null, e.current = n, Da = l;
            do {
                try {
                    for (w = e; null !== Da;) {
                        var E = Da.effectTag;
        ...
        if (Aa) Aa = !1, Ua = e, Ba = t; else for (Da = l; null !== Da;) t = Da.nextEffect, Da.nextEffect = null, Da = t;
        if (0 === (t = e.firstPendingTime) && (La = null), 1073741823 === t ? e === $a ? Wa++ : (Wa = 0, $a = e) : Wa = 0, "function" === typeof ku && ku(n.stateNode, r), Ga(e), Fa) throw Fa = !1, e = ja, ja = null, e;
    ...
    function hu() {
        for (; null !== Da;) {
            var e = Da.effectTag;
            0 !== (256 & e) && na(Da.alternate, Da), 0 === (512 & e) || Aa || (Aa = !0, Wl(97, (function () {
                return mu(), null
            }))), Da = Da.nextEffect
        }
    }
    ...
    function vu(e, t, n) {
        ui(e, t = ha(e, t = Jo(n, t), 1073741823)), null !== (e = Ya(e, 1073741823)) && Ga(e)
    }
        ...
        if (3 === e.tag) vu(e, e, t); else for (var n = e.return; null !== n;) {
            ...
            if (1 === n.tag) {
                ...
                if ("function" === typeof n.type.getDerivedStateFromError || "function" === typeof r.componentDidCatch && (null === La || !La.has(r))) {
                    ui(n, e = ma(n, e = Jo(t, e), 1073741823)), null !== (n = Ya(n, 1073741823)) && Ga(n);
                    break
                }
            }
            n = n.return
    ...
    function bu(e, t, n) {
        var r = e.pingCache;
        null !== r && r.delete(t), Ta === e && Ca === n ? _a === xa || _a === ka && 1073741823 === Oa && Al() - Ma < 500 ? nu(e, Ca) : Ia = !0 : zu(e, n) && (0 !== (t = e.lastPingedTime) && t < n || (e.lastPingedTime = n, Ga(e)))
    }

    function wu(e, t) {
        var n = e.stateNode;
        null !== n && n.delete(t), 0 === (t = 0) && (t = Ka(t = Qa(), e, null)), null !== (e = Ya(e, t)) && Ga(e)
    }
    ...
    ya = function (e, t, n) {
        ...
        if (null !== e) {
            ...
            if (e.memoizedProps !== l || dl.current) No = !0; else {
                if (r < n) {
                    switch (No = !1, t.tag) {
                        case 3:
                            Ao(t), Po();
                        ...
                        case 10:
                            ...
                            break;
                        case 13:
                            if (null !== t.memoizedState) return 0 !== (r = t.child.childExpirationTime) && r >= n ? $o(e, t, n) : (cl(Di, 1 & Di.current), null !== (t = qo(e, t, n)) ? t.sibling : null);
                            cl(Di, 1 & Di.current);
                            break;
                        case 19:
                            ...
                            if (null !== (l = t.memoizedState) && (l.rendering = null, l.tail = null), cl(Di, Di.current), !r) return null
                    }
                    return qo(e, t, n)
                }
                No = !1
        ...
        switch (t.expirationTime = 0, t.tag) {
            case 2:
                if (r = t.type, null !== e && (e.alternate = null, t.alternate = null, t.effectTag |= 2), e = t.pendingProps, l = hl(t, fl.current), ni(t, n), l = Ki(null, t, r, e, l, n), t.effectTag |= 1, "object" === typeof l && null !== l && "function" === typeof l.render && void 0 === l.$$typeof) {
                    ...
                    "function" === typeof a && hi(t, r, a, e), l.updater = mi, t.stateNode = l, l._reactInternalFiber = t, bi(t, r, e, n), t = Lo(null, t, r, !0, i, n)
            ...
            case 16:
                ...
                return t;
            case 0:
                return r = t.type, l = t.pendingProps, Fo(e, t, r, l = t.elementType === r ? l : ql(r, l), n);
            case 1:
            ...
            case 3:
                ...
                if (r = t.pendingProps, l = null !== (l = t.memoizedState) ? l.element : null, oi(e, t), si(t, r, null, n), (r = t.memoizedState.element) === l) Po(), t = qo(e, t, n); else {
                    if ((l = t.stateNode.hydrate) && (ko = kn(t.stateNode.containerInfo.firstChild), wo = t, l = xo = !0), l) for (n = Si(t, null, r, n), t.child = n; n;) n.effectTag = -3 & n.effectTag | 1024, n = n.sibling; else Ro(e, t, r, n), Po();
                    t = t.child
                }
                return t;
            case 5:
                return Ii(t), null === e && So(t), r = t.type, l = t.pendingProps, i = null !== e ? e.memoizedProps : null, a = l.children, gn(r, l) ? a = null : null !== i && gn(r, i) && (t.effectTag |= 16), Do(e, t), 4 & t.mode && 1 !== n && l.hidden ? (t.expirationTime = t.childExpirationTime = 1, t = null) : (Ro(e, t, a, n), t = t.child), t;
            case 6:
            ...
            case 11:
                return r = t.type, l = t.pendingProps, zo(e, t, r, l = t.elementType === r ? l : ql(r, l), n);
            case 7:
            ...
            case 10:
                e:{
                    ...
                    if (cl(Yl, u._currentValue), u._currentValue = i, null !== a) if (u = a.value, 0 === (i = jr(u, i) ? 0 : 0 | ("function" === typeof r._calculateChangedBits ? r._calculateChangedBits(u, i) : 1073741823))) {
                ...
                return t;
            case 9:
                return l = t.type, r = (i = t.pendingProps).children, ni(t, n), r = r(l = ri(l, i.unstable_observedBits)), t.effectTag |= 1, Ro(e, t, r, n), t.child;
            case 14:
                return i = ql(l = t.type, t.pendingProps), Io(e, t, l, i = ql(l.type, i), r, n);
            case 15:
                return Mo(e, t, t.type, t.pendingProps, r, n);
            case 17:
                return r = t.type, l = t.pendingProps, l = t.elementType === r ? l : ql(r, l), null !== e && (e.alternate = null, t.alternate = null, t.effectTag |= 2), t.tag = 1, ml(r) ? (e = !0, bl(t)) : e = !1, ni(t, n), vi(t, r, l), bi(t, r, l, n), Lo(null, t, r, !0, e, n);
            case 19:
                return Ko(e, t, n)
        }
        throw Error(o(156, t.tag))
    ...
    function Fu(e, t, n, r) {
        var l = t.current, i = Qa(), a = di.suspense;
        i = Ka(i, l, a);
        e:if (n) {
            t:{
        ...
        return null === t.context ? t.context = n : t.pendingContext = n, (t = ai(i, a)).payload = {element: e}, null !== (r = void 0 === r ? null : r) && (t.callback = r), ui(l, t), qa(l, i), i
    }
    ...
    function Uu(e, t, n) {
        var r = new Ru(e, t, n = null != n && !0 === n.hydrate), l = Tu(3, null, null, 2 === t ? 7 : 1 === t ? 3 : 0);
    ...
    var Hu = {
        Events: [Pn, On, Nn, C, E, jn, function (e) {
            lt(e, Fn)
        }, z, I, Gt, at, mu, {current: !1}]
    };
    !function (e) {
    ...
    var O = [], N = [], R = 1, z = null, I = 3, M = !1, D = !1, F = !1;
    ...
    function L(e) {
        if (F = !1, j(e), !D) if (null !== C(O)) D = !0, r(A); else {
            var t = C(N);
    ...
    function A(e, n) {
        ...
        var r = I;
        try {
            for (j(n), z = C(O); null !== z && (!(z.expirationTime > n) || e && !o());) {
                var a = z.callback;
                if (null !== a) {
                    z.callback = null, I = z.priorityLevel;
                    var u = a(z.expirationTime <= n);
                    n = t.unstable_now(), "function" === typeof u ? z.callback = u : z === C(O) && _(O), j(n)
                } else _(O);
                z = C(O)
            }
    ...
    t.unstable_IdlePriority = 5, t.unstable_ImmediatePriority = 1, t.unstable_LowPriority = 4, t.unstable_NormalPriority = 3, t.unstable_Profiling = null, t.unstable_UserBlockingPriority = 2, t.unstable_cancelCallback = function (e) {
        ...
        return e = {
            ...
            sortIndex: -1
        }, u > a ? (e.sortIndex = u, S(N, e), null === C(O) && e === C(N) && (F ? i() : F = !0, l(L, u - a))) : (e.sortIndex = o, S(O, e), D || M || (D = !0, r(A))), e
    ...
    }(), l = n(0), i = s(l), o = s(n(18)), a = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
        return t.default = e, t
    }(n(9)), u = s(n(21)), c = s(n(23));
    ...
    var f = function () {
        ...
        function t(e) {
            var n = e.history, r = e.structure, l = e.extensions, i = e.prefix;
            !function (e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, t);
            var o = function (e, t) {
            ...
            return o.Bash = new u.default(l), o.ctrlPressed = !1, o.state = {
                ...
                cwd: ""
            }, o.handleKeyDown = o.handleKeyDown.bind(o), o.handleKeyUp = o.handleKeyUp.bind(o), o
        }
        ...
        return function (e, t) {
            ...
            key: "componentWillReceiveProps", value: function (e) {
                var t = e.extensions, n = e.structure, r = e.history, l = {};
                n && (l.structure = Object.assign({}, n)), r && (l.history = r.slice()), t && (this.Bash.commands = Object.assign({}, t, a)), this.setState(l)
            }
        }, {
            ...
            key: "attemptAutocomplete", value: function () {
                var e = this.refs.input.value, t = this.Bash.autocomplete(e, this.state);
                t && (this.refs.input.value = t)
            }
        }, {
            key: "handleKeyDown", value: function (e) {
                17 === e.which ? this.ctrlPressed = !0 : 9 === e.which && (this.attemptAutocomplete(), e.preventDefault())
            }
        }, {
            key: "handleKeyUp", value: function (e) {
                76 === e.which ? this.ctrlPressed && this.setState(this.Bash.execute("clear", this.state)) : 67 === e.which ? this.ctrlPressed && (this.refs.input.value = "") : 38 === e.which ? this.Bash.hasPrevCommand() && (this.refs.input.value = this.Bash.getPrevCommand()) : 40 === e.which ? this.Bash.hasNextCommand() ? this.refs.input.value = this.Bash.getNextCommand() : this.refs.input.value = "" : 17 === e.which && (this.ctrlPressed = !1)
            }
        }, {
            key: "handleSubmit", value: function (e) {
                e.preventDefault();
                var t = e.target[0].value, n = this.Bash.execute(t, this.state);
                this.setState(n), this.refs.input.value = ""
            }
        }, {
            key: "renderHistoryItem", value: function (e) {
                var t = this;
                return function (n, r) {
                    var l = n.hasOwnProperty("cwd") ? i.default.createElement("span", {style: e.prefix}, t.props.prefix + " ~" + n.cwd + " $") : void 0;
                    return i.default.createElement("div", {"data-test-id": "history-" + r, key: r}, l, n.value)
                }
            }
        }, {
            key: "render", value: function () {
                var e = this, t = this.props, n = t.onClose, r = t.onExpand, l = t.onMinimize, o = t.prefix,
                    a = t.styles, u = t.theme, s = this.state, f = s.history, d = s.cwd,
                    p = Object.assign({}, c.default[u] || c.default.light, a);
                return i.default.createElement("div", {
                    className: "ReactBash",
                    style: p.ReactBash
                }, i.default.createElement("div", {style: p.header}, i.default.createElement("span", {
                    style: p.redCircle,
                    onClick: n
                }), i.default.createElement("span", {
                    style: p.yellowCircle,
                    onClick: l
                }), i.default.createElement("span", {
                    style: p.greenCircle,
                    onClick: r
                })), i.default.createElement("div", {
                    style: p.body, onClick: function () {
                        return e.refs.input.focus()
                    }
                }, f.map(this.renderHistoryItem(p)), i.default.createElement("form", {
                    onSubmit: function (t) {
                        return e.handleSubmit(t)
                    }, style: p.form
                }, i.default.createElement("span", {style: p.prefix}, o + " ~" + d + " $"), i.default.createElement("input", {
                    autoComplete: "off",
    ...
    t.default = d, d.Themes = {LIGHT: "light", DARK: "dark"}, d.propTypes = {
        extensions: o.default.object,
        history: o.default.array,
        onClose: o.default.func,
        onExpand: o.default.func,
        onMinimize: o.default.func,
        prefix: o.default.string,
        structure: o.default.object,
    ...
    }(), l = u(n(6)), i = n(1), o = u(n(9)), a = u(n(22));
    ...
    var s = function () {
        function e() {
            ...
            c(this, e), this.commands = Object.assign(t, o), this.prevCommands = [], this.prevCommandsIndex = 0
        }

        return r(e, [{
            key: "execute", value: function (e, t) {
                this.prevCommands.push(e), this.prevCommandsIndex = this.prevCommands.length;
                var n = Object.assign({}, t, {history: t.history.concat({cwd: t.cwd, value: e})}), r = a.parse(e);
                return this.runCommands(r, n)
            }
        }, {
            key: "runCommands", value: function (e, t) {
                for (var n = this, r = !1, o = function (e, t) {
                    if ("" === t.name) return e;
                    if (n.commands[t.name]) {
                        var o = n.commands[t.name].exec(e, t);
                        return r = r || o && o.error, o
                    }
                    return r = !0, l.appendError(e, i.Errors.COMMAND_NOT_FOUND, t.name)
                }; !r && e.length;) {
                    t = e.shift().reduce(o, t)
                }
                return t
            }
        }, {
            key: "autocomplete", value: function (e, t) {
                var n = t.structure, r = t.cwd, i = e.split(/ +/), o = i.pop(), a = function (e) {
                    return 0 === e.indexOf(o)
                }, u = function (e) {
                    return i.concat(e).join(" ")
                };
                if (0 === i.length) {
                    var c = Object.keys(this.commands).filter(a);
                    return 1 === c.length ? u(c[0]) : null
                }
                var s = o.split("/");
                o = s.pop();
                var f = s.join("/"), d = l.extractPath(f, r), p = l.getDirectoryByPath(n, d), h = p.err, m = p.dir;
                if (h) return null;
                var y = Object.keys(m).filter(a), v = f ? f + "/" : "";
                return 1 === y.length ? u("" + v + y[0]) : null
            }
        }, {
            key: "getPrevCommand", value: function () {
                return this.prevCommands[--this.prevCommandsIndex]
            }
        }, {
            key: "getNextCommand", value: function () {
                return this.prevCommands[++this.prevCommandsIndex]
            }
        }, {
            key: "hasPrevCommand", value: function () {
                return 0 !== this.prevCommandsIndex
            }
        }, {
            key: "hasNextCommand", value: function () {
    ...
    function r(e) {
        for (var t = e.split(/ +/), n = t.shift(), r = {}, l = {}, i = 0; t.length > 0;) {
            var o = t.shift();
            if ("-" === o[0]) if ("-" === o[1]) {
                var a = t.shift();
                l[o.slice(2)] = a
            } else o.slice(1).split("").forEach((function (e) {
                r[e] = !0
            })); else l[i++] = o
        }
        return {name: n, flags: r, input: e, args: l}
    }

    Object.defineProperty(t, "__esModule", {value: !0}), t.parseInput = r, t.parse = function (e) {
    ...
    }, l = {borderRadius: "50%", display: "inline-block", height: "15px", marginRight: "5px", width: "15px"};
    r.redCircle = Object.assign({}, l, {backgroundColor: "#bf616a"}), r.yellowCircle = Object.assign({}, l, {backgroundColor: "#ebcb8b"}), r.greenCircle = Object.assign({}, l, {backgroundColor: "#a3be8c"}), r.body = {
        flexGrow: 1,
        overflowY: "scroll",
        padding: "10px"
    }, r.form = {display: "flex"}, r.input = {
        background: "none",
        border: "none",
        color: "inherit",
        flexGrow: "1",
        ...
        padding: 0
    }, r.prefix = {marginRight: "5px"}, t.default = {
        light: Object.assign({}, r, {
            body: Object.assign({}, r.body, {
                backgroundColor: "#fff",
                color: "#5D5D5D"
            }),
            header: Object.assign({}, r.header, {backgroundColor: "#eee"}),
            prefix: Object.assign({}, r.prefix, {color: "#bd081c"})
        }),
        dark: Object.assign({}, r, {
            body: Object.assign({}, r.body, {backgroundColor: "#000", color: "#d0d0d0"}),
            header: Object.assign({}, r.header, {backgroundColor: "#dcdbdb"}),
            prefix: Object.assign({}, r.prefix, {color: "#5b65fb"})
        })
    }
}]]);
